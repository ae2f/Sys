...
#ifndef	ae2fsys_ftx_others_h
#define	ae2fsys_ftx_others_h
#include <ae2f/Sys/.ftx/core.h>


#if	_AE2FSYS_FTX_OTHERS
...
#ifndef	AE2FSYS_FTX_OTHERS_LIB_STATIC
#define	AE2FSYS_FTX_OTHERS_LIB_STATIC		0
#endif

#ifndef	AE2FSYS_FTX_OTHERS_LIB_DYLINK
#define	AE2FSYS_FTX_OTHERS_LIB_DYLINK	0
#endif

#ifndef	AE2FSYS_FTX_OTHERS_LIB_INIT
#define	AE2FSYS_FTX_OTHERS_LIB_INIT	0
#endif
...
#if	AE2FSYS_FTX_OTHERS_LIB_INIT
#define	S_INIT(a)		a
#else
#define S_INIT(a)
#endif

#if	AE2FSYS_FTX_OTHERS_LIB_DYLINK
#if		AE2FSYS_FTX_OTHERS_LIB_EXTERN_INIT
...
S_EXTERN S_LINK pthread_mutex_t __ae2f_gSysFtxMtx S_INIT(= PTHREAD_MUTEX_INITIALIZER);
S_EXTERN S_LINK pthread_cond_t __ae2f_gSysFtxCnd S_INIT(= PTHREAD_COND_INITIALIZER);
		...
		ae2f_unused ae2fsys_ftxel_t* const prm_uaddr)
{
	...
	ae2f_unexpected_else((ret_err)) {
		switch(pthread_cond_signal(&(__ae2f_gSysFtxCnd))) {
			case EFAULT:
				(ret_err) = AE2FSYS_FTX_PTRINVAL;
				break;
			case ENOTRECOVERABLE:
