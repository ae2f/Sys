...
#define	_AE2FSYS_FTX_WAITONADDR	_AE2FSYS_PROBE_WINDOWS
#define	_AE2FSYS_FTX_SYSCALL	_AE2FSYS_PROBE_LINUX
#define	_AE2FSYS_FTX_FUTEX	_AE2FSYS_PROBE_OPENBSD

#define	_AE2FSYS_FTX_PTHREAD	\
	(!(_AE2FSYS_FTX_WAITONADDR || _AE2FSYS_FTX_SYSCALL || _AE2FSYS_FTX_FUTEX))
